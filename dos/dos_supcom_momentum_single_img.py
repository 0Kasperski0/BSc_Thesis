...
for filename in os.listdir(directory):
	if filename.endswith(".dat"):
		...
		for num,i in enumerate([2,6,10]):
			...
			ax.text(0, 5, r'$E_F$', fontsize=10,rotation=0)
			...
			if zoom==True:
				file='m_zoom/'+'supcom_zoom_'+ats[num]+'_in_'+filename
			else:
				file='m_full/'+'supcom_'+ats[num]+'_in_'+filename
